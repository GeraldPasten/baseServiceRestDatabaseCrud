...
import ${package}.services.vo.Usuario;
...
public class UsuarioCrudRoutes extends RouteBuilder {
        ...
        public void configure() throws Exception {
                ...
                rest("/usuario")
                        ...
                        .log("Error al Obtener usuarios: ${symbol_dollar}{exception.message}")
                        ...
                        .log("Creando un usuario nuevo: ${symbol_dollar}{body}")
                        .doTry()
                        ...
                        .doTry()
                        .toD("jpa://"+Usuario.class.getName()+"?query="+delete +"="+"${symbol_dollar}{header.id}&useExecuteUpdate=true")
                        .doCatch(HibernateException.class, PersistenceException.class)
                        .log("Error al Obtener usuarios: ${symbol_dollar}{exception.message}")
